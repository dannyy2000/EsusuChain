  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <nav className="relative z-10 border-b border-white/10 glass-effect">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button className="px-4 py-2 rounded-lg glass-effect text-sm border border-white/10 hover:border-primary-500/50 transition-colors">
              0xa8965...d113
            </button>
            <button className="px-4 py-2 rounded-lg glass-effect text-sm border border-white/10 hover:border-primary-500/50 transition-colors">
              99,999 FLOW
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Circles Grid */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-6">Your Circles</h2>
              ...
              >
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-semibold">{circle.cycleDuration}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-400">Current Cycle</span>
                    <span className="font-semibold">{circle.currentCycle} of {circle.members}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-400">Your Position</span>
                    <span className="font-semibold">#{circle.yourPosition}</span>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between text-xs text-gray-400 mb-2">
                    <span>Progress</span>
                    <span>{Math.round((circle.currentCycle / circle.members) * 100)}%</span>
                  </div>
                  <div className="h-2 bg-gray-800 rounded-full overflow-hidden">
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{ width: `${(circle.currentCycle / circle.members) * 100}%` }}
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                  <div className="flex items-center gap-2 text-sm text-gray-400">
                    ...
                    <span>Next payout in {circle.nextPayout}</span>
                  </div>
